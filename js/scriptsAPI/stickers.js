...
async function getStickers(event) {
  ...
  if (stickerObj.sticker === '') return showAlert('El campo no puede estar vacío');
  ...
  try {
    const url = 'https://cors-anywhere.herokuapp.com/https://bymykel.github.io/CSGO-API/api/es-ES/stickers.json';
