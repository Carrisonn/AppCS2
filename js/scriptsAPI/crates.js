...
async function getCrates(event) {
  ...
  if (crateObj.crate === '') return showAlert('El campo no puede estar vacío');
  ...
  try {
    const url = 'https://cors-anywhere.herokuapp.com/https://bymykel.github.io/CSGO-API/api/es-ES/crates.json';
